...
from app.models.models import User, Device, Course, Video, UserCourse, ActivationCode
...
async def generate_codes(course_id: int, count: int = 1, db: Session = Depends(get_db)):
